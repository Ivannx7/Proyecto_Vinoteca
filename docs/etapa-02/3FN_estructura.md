...
## Solución: 
corregir el nombre de la clave foránea apuntando a Categoria(id_categoria) y agregar el campo id_bodega (FK->Bodega) en la tabla vinos.po id_bodega en la tabla vinos.
